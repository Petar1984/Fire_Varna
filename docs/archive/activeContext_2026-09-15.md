> FROZEN on 2026-09-25 at commit 8b80a20 (data cycle #45). State as of 2026-09-15 (lot О closed, d323959); the table below was last re-measured on 2026-09-05 and the numbers were not re-verified after that date. Live entry point: [../activeContext.md](../activeContext.md).
...
> One page. Every number below is the output of the command next to it, run on the date above; a number without a command does not enter. The chronicle of 03–04.09 (ЛОТ 1, 1в-А, 1в-Б, 1в-В, the pre-rebase hash table) is frozen in [activeContext_2026-09-04.md](activeContext_2026-09-04.md); the one before it in [activeContext_2026-07-04.md](activeContext_2026-07-04.md).
